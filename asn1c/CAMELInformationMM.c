...
static asn_TYPE_tag2member_t asn_MAP_CAMELInformationMM_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 3, 0, 0 }, /* numberOfDPEncountered */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 4, 0, 0 }, /* levelOfCAMELService */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 5, 0, 0 }, /* freeFormatData */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 6, 0, 0 } /* fFDAppendIndicator */
};
